          ...
          {stats.map((stat, index) => {
            ...
            return (
              <ScaleIn
                key={index}
                delay={index * 0.1}
                className="relative p-6 rounded-3xl hover:scale-105 bg-primary/90 backdrop-blur-sm border border-white/10 hover:border-primary/50 transition-all duration-300 group"
              >
                <div className="w-14 h-14 rounded-xl flex items-center justify-center bg-primary/50 group-hover:scale-110 transition-transform duration-300">
