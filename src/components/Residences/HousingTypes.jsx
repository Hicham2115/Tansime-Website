      ...
      <div className="container relative px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-20">
          {housingTypes.map((housing, index) => (
            <div
              key={index}
              className="group relative overflow-hidden rounded-2xl bg-white/70 border border-white/20 hover:border-primary/50 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-primary/10"
            >
              <div className="relative p-8 space-y-6">
                <div className="flex items-start justify-between">
                  <div className="space-y-2">
                    ...
                    <p className="text-black/80">{housing.description}</p>
                  </div>
                ...
                <div className="flex items-center gap-6 pt-4 border-t border-border/50">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-black">{housing.size}</span>
                  </div>
                </div>
              </div>
            </div>
