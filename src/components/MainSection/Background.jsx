  ...
  return (
    <div className="fixed inset-0 -z-10 bg-gradient-to-br from-[#1a4d54] via-[#225f66] to-[#e8f5f5] overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 30% 20%, rgba(34, 95, 102, 0.4) 0%, transparent 50%), radial-gradient(circle at 70% 80%, rgba(43, 112, 119, 0.3) 0%, transparent 50%)",
          animation: "pulse 8s ease-in-out infinite alternate",
        }}
      ></div>

      {/* Global dark overlay as requested */}
