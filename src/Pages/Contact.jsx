                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start gap-2">
                      ...
                      >
                        <button className="inline-flex cursor-pointer items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold text-sm sm:text-base px-4 py-2 rounded-full shadow-md transition-colors duration-300 mt-2">
                          <svg
                            viewBox="0 0 24 24"
                            width="24"
                            height="24"
