        ...
        <div className="container relative z-10 px-4 md:px-6 py-20">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white animate-fade-in-up animation-delay-100">
              Get in Touch with{" "}
              <span className="text-transparent bg-clip-text bg-linear-to-r from-[#d9ac6f] via-[#c9944f] to-[#d9ac6f]">
                Tasnime Immobilier
              </span>
            </h1>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-2">
              <div className="p-8 md:p-10 rounded-2xl bg-[#292727] border border-white/10 shadow-xl hover:shadow-2xl transition-all duration-300">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-white/5 border-2 border-white/10 rounded-xl focus:border-primary focus:outline-none transition-colors duration-300 text-white placeholder:text-gray-500"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full px-4 py-3 bg-white/5 border-2 border-white/10 rounded-xl focus:border-primary focus:outline-none transition-colors duration-300 resize-none text-white placeholder:text-gray-500"
            ...
            <div className="space-y-6">
              {/* Company Info Card */}
              <div className="p-8 rounded-2xl bg-[#292727] border border-white/10 shadow-lg">
              ...
              {/* Map Placeholder */}
              <div className="rounded-2xl overflow-hidden border border-white/10 shadow-md aspect-square bg-[#292727]">
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            <div className="p-8 rounded-2xl bg-[#292727] border border-white/10 text-center shadow-lg">
